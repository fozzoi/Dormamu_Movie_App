...
import { ScrollContext } from '../context/ScrollContext'; // FIX: Corrected import path
...
const CastDetails = () => {
  ...
  const { personId } = route.params as { personId: number }; // Correctly gets personId
...
const styles = StyleSheet.create({
  ...
  mediaCardContainer: {
    width: (width - 19) / 3, // Adjusted calculation for 3 columns
    marginBottom: 16,
    paddingHorizontal: 4,
  },
  mediaCard: {
